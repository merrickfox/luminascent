...
burn_time_hours: integer hours per size variant. wax_type: soy, paraffin, beeswax, vegetable wax, coconut, rapeseed. vessel_material: glass, ceramic, tin, metal, concrete, porcelain, wood."""
    ...
    *,
    ...
    payload = {
        ...
        "messages": [
            ...
            {"role": "user", "content": f"Extract candle product fields from this page text:\n\n{trimmed}"},
        ],
    }
...
def merge_extractions(
    ...
    *,
    ...
    wax_type = json_ld_data.get("wax_type") or llm_data.get("wax_type") or parse_wax_type(text_for_parse)
