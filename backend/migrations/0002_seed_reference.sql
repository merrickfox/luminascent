...
INSERT INTO vote_options (id, dimension_id, label, slug, sort_order) VALUES
  ...
  ('vo-very-weak', 'vd-longevity', 'Fleeting', 'very_weak', 1),
  ('vo-weak', 'vd-longevity', 'Brief', 'weak', 2),
  ...
  ('vo-enormous', 'vd-sillage', 'Fills the room', 'enormous', 4),
